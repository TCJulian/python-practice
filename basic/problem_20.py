...
if __name__ == "__main__":
    ...
    print('Search number: 1')
    print('List: 1')
    print('Expected outcome: Invalid input, None')
    print(f'Actual outcome: {binary_search(1, 1)}')
    ...
    print('List: ["abc1"]')
    print('Expected outcome: Invalid input, None')
    print(f'Actual outcome: {binary_search(["abc1"], 1)}')

    print()
    print('Test 13')
    print('Search number: a')
    print('List: [1, 2, 3, 4]')
    print('Expected outcome: Invalid input, None')
    print(f'Actual outcome: {binary_search(list(range(1,5)), "a")}')
