...
def is_valid_word(word, hand, word_list):
    ...
    if '*' in word:
        wildcard_words = [word.replace('*', vowel) for vowel in VOWELS]
        valid_word = False
    ...
    * Returns the total score for the series of hands
    ...
    while hands > 0:
        ...
        if substitutes:
            print("Current hand: ", end=" ")
            display_hand(hand)
            answer = input("Would you like to substitute a letter? ").lower().strip()
            if answer == "yes":
                substitutes = False
                sub_letter = input("Which letter would you like to subsitute? ").lower().strip()
        ...
        if replays:
            answer = input("Would you like to replay the hand? ").lower().strip()
            print()
            if answer == "yes":
                replays = False
